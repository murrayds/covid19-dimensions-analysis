...
get_funder_table <- function(topic) {
  read_delim(paste0("/Users/d.murray/Documents/covid19-dimensions-analysis/data/bq-data/funding_orgs/funding_orgs_covid-",
                    topic, 
                    ".tsv"), 
             delim = "\t")
}
...
get_recipient_table <- function(topic) {
  read_delim(paste0("/Users/d.murray/Documents/covid19-dimensions-analysis/data/bq-data/funding_orgs/funding_recipients_covid-",
                    topic, 
                    ".tsv"), 
             delim = "\t")
}
